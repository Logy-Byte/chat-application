...
class _CallsScreenState extends State<CallsScreen> {
  ...
  ChatyDataStore get dataStore => widget.dataStore;
            ...
            if (historyError != null && calls.isEmpty)
              SliverFillRemaining(
                ...
                child: ChatyEmptyState(
                  ...
                  message:
                      'Chaty could not load your protected call history. Pull down or retry.',
              ...
              SliverFillRemaining(
                ...
                child: ChatyEmptyState(
                  ...
                  message:
                      'Completed, missed, and declined server call sessions will appear here.',
