...
class SettingsRegistry {
  ...
  static const List<SettingsCluster> clusters = <SettingsCluster>[
    ...
    SettingsCluster(
      ...
      settings: [
        SettingDefinition<bool>(
          ...
          description:
              'Prevents the server from updating your last seen timestamp',
          category: SettingsCategory.privacy,
    ...
    SettingsCluster(
      ...
      settings: [
        SettingDefinition<bool>(
          ...
          description:
              'Retain deleted messages sent by others in conversations',
          category: SettingsCategory.privacy,
        ...
        SettingDefinition<bool>(
          ...
          description:
              'Keep deleted status updates accessible until normal expiry',
          category: SettingsCategory.privacy,
    ...
    SettingsCluster(
      ...
      settings: [
        SettingDefinition<String>(
          ...
          title: 'Bubble Style',
          description:
              'Shape and contour treatment for incoming and outgoing messages',
          category: SettingsCategory.chats,
          subcategory: 'Visuals',
    ...
    SettingsCluster(
      ...
      description:
          'Swipe actions, double-tap emoji, animated stickers and sidebar',
      category: SettingsCategory.chats,
      settings: [
        SettingDefinition<bool>(
        ...
        SettingDefinition<String>(
          ...
          description:
              'Quick emoji reaction placed on double-tapping a message',
          category: SettingsCategory.chats,
          subcategory: 'Interactions',
          controlType: SettingControlType.singleChoice,
    ...
    SettingsCluster(
      ...
      description:
          'Original layout systems and component-level overrides (Navigation, Composer, Conversation, Profile)',
      ...
      settings: [
        SettingDefinition<String>(
          ...
          title: 'Templates',
          description:
              'Apply complete UI archetypes or customize by individual component',
          category: SettingsCategory.appearance,
    ...
    SettingsCluster(
      ...
      settings: [
        SettingDefinition<String>(
          ...
          title: 'Theme Presets',
          description:
              'Curated color themes including Warm Neutral, True Dark AMOLED and Cobalt',
          category: SettingsCategory.appearance,
    ...
    SettingsCluster(
      ...
      settings: [
        ...
        SettingDefinition<bool>(
          ...
          description:
              'Provide dedicated tabs for direct messages and group conversations',
          category: SettingsCategory.homeAndNavigation,
          subcategory: 'Tabs',
          controlType: SettingControlType.toggle,
    ...
    SettingsCluster(
      ...
      description:
          'Incoming call permissions, dynamic island, and audio optimization',
      ...
      settings: [
        SettingDefinition<String>(
          ...
          description:
              'Audience permitted to initiate voice and video calls with you',
          category: SettingsCategory.calls,
          subcategory: 'Privacy',
          controlType: SettingControlType.singleChoice,
