...
void main() {
  group('Settings System & Registry Tests', () {
    ...
    test('Canonical Settings Categories cover all 5 root groups', () {
      ...
      expect(
        SettingsRegistry.clustersForCategory(SettingsCategory.chats).isNotEmpty,
        isTrue,
      );
      expect(
        SettingsRegistry.clustersForCategory(
      ...
      expect(
        SettingsRegistry.clustersForCategory(
          SettingsCategory.homeAndNavigation,
        ).isNotEmpty,
        isTrue,
      );
      expect(
      ...
      expect(
        SettingsRegistry.clustersForCategory(SettingsCategory.calls).isNotEmpty,
        isTrue,
      );
      expect(
        SettingsRegistry.clustersForCategory(
          SettingsCategory.storageAndMedia,
        ).isNotEmpty,
        isTrue,
      );
      expect(
