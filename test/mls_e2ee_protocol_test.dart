...
void main() {
  ...
  test(
    ...
    skip: linuxGithubHost
        ? 'OpenMLS native assets are installed by flutter build, not the Linux host flutter-test runner. Android release build remains mandatory.'
        : false,
  );
}
